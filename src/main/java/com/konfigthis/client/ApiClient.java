...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://cloud.lambdalabs.com/api/v1";
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.5.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloud.lambdalabs.com/api/v1)
