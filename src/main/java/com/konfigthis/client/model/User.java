 ...
 */
@ApiModel(description = "Information about a user in your team")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class User {
  ...
  **/
  ...
  @ApiModelProperty(example = "0920582c7ff041399e34823a0be62549", required = true, value = "Unique identifier for the user")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "teammate@example.com", required = true, value = "Email address of the user")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Status of the user's account")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, email, status, additionalProperties);
  }
