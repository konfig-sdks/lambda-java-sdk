...
public class SshKeyApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SshKeyApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public SshKeyApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
